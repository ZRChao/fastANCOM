...
> __Take a look of the computation time with 100 replicates, fastANCOM thousand times faster than original ANCOM__
...
We present plots of reject number of each microbe, valcano plot, and the effect size estimation compared to the true settings.
...
ep <- ggplot(data=tmpb, aes(x=Microbe, y=log2FC, color=Type, shape=Type))  +
  ...
  theme_linedraw() + labs(title='Effect size') +
  scale_colour_brewer(palette = "Set1", direction=-1) +
